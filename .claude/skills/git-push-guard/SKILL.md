...
4. **DM_Temp 中已归档但未删除**（凡含归档标记如 `_archived` / `_done` 的内容）
...
- 00-public/1-product/spec/（spec 文件 3 天前更新，README 14 天前）
```
...
[3/3] README 健康
  覆盖率 8/9（89%）
  缺失：DM_Temp/README.md
  可能过期：00-public/1-product/spec/README.md
