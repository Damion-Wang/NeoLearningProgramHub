...
#### B · `design/[已审阅]00-future-iterations.md`
...
#### H · `learner/[已审阅]01-hall.md` 🔴 **本期重大更新文件**
...
#### I · `learner/[已审阅]02-lecture-zone.md` 🟡
...
#### J · `learner/[已审阅]03-practice-zone.md` 🔴
...
#### K · `learner/[已审阅]04-inquiry-zone.md` 🟡
...
#### L · `learner/[已审阅]05-report-zone.md` 🟡
...
#### O · `management/[已审阅]00-overview.md` 🟡
...
#### P · `management/[已审阅]01-operation.md` 🟡
...
#### Q · `management/[已审阅]02-report-gen.md` 🟡
...
#### R · `management/[已审阅]03-project-config.md` 🔴 **本期重大更新**
...
#### S · `management/[已审阅]04-message.md` ⚪
