...
- D-5.0 spec 已交付（2026-05-06），详见 [../product-V-0.2.0-D-5.0/spec/](../product-V-0.2.0-D-5.0/spec/)（22 文件 / 全部【已审阅】 / 每文件独立编号）
- D-4.0 中"未被推翻"的内容继承，"被推翻"部分以 D-5.0 为准
- D-5.0 推翻 D-4.0 的清单见 [../product-V-0.2.0-D-5.0/spec/01-vision【已审阅】.md](../product-V-0.2.0-D-5.0/spec/01-vision【已审阅】.md) 等
